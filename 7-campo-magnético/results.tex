...
Con lo explicado en el apartado~\ref{sec:dispositivo-experimental}, medimos el ángulo de desviación $\alpha$ de la brújula
para distintas intensidades $I$ circulando por el cable conductor y con distintas distancias $d$ entre la brújula y el cable.
...
\begin{table}[h!]
    ...
    \begin{centering}
        \begin{tabular}{|P{24px}|P{26px}|P{26px}|P{26px}|P{26px}|P{26px}|}
            ...
            {\csvcoli & \csvcoliv               & \csvcolv                & \csvcolvi               & \csvcolvii              & \csvcolviii}% specify your columns here
            \hline
        \end{tabular}
    \end{centering}
\end{table}
