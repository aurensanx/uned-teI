...
\subsection{\label{sub:results}Análisis}

Represente la deformación frente a la masa

\begin{figure}[tbh]
    \begin{centering}
        \includegraphics[width=1\columnwidth]{files/images/fig1}
    \end{centering}
    \caption{\label{fig:resultado}Deformación frente a masa}
\end{figure}
