...
Por último, se vierte el mismo líquido en el cilindro hueco y se toma la medida con el cilindro macizo todavía sumergido ($P_{ap} + P_{agua}$).
...
\begin{table}[h!]
    ...
    \begin{centering}
        \begin{tabular}{|P{40px}|P{37px}|P{37px}|P{65px}|}
            \hline
            Líquido   & $P_{vac}\,$(N) & $P_{ap}\,$(N) & $P_{ap} + P_{agua}\,$(N)              \\
            \hline
...
El principio de Arquímedes afirma que $P_{vac}$ y $P_{ap} + P_{agua}$ deben ser iguales.
...
En esta sección, se utiliza un soporte al que se van añadiendo pesas de masas $m$.
