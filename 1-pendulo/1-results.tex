...
Fijándonos en los valores obtenidos de la dispersión $D_m$, un valor razonable del error absoluto en la medición de los tiempos es $\pm 0.2\,s$.
...
\begin{table}[h!]
    ...
    \begin{centering}
        \begin{tabular}{|P{56px}|P{67px}|P{67px}|}
            ...
            Masa 2, 45\textdegree & 2,09 \pm\; 0,03           & 9,0 \pm\; 0,3         \\
            \hline
        \end{tabular}
    \end{centering}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{centering}
        \begin{tabular}{|P{50px}|P{71px}|P{69px}|}
            ...
            & $a\;\text{(s/m$^{1/2}$)}$ & $g\;\text{(m/s$^2$)}$ \\
            \hline
            Masa 1, 20\textdegree & 0,2504 \pm\; 0,0014       & 9,89 \pm\; 0,06       \\
            Masa 1, 45\textdegree & 0,227 \pm\; 0,004         & 8,96 \pm\; 0,16       \\
            Masa 2, 20\textdegree & 0,249 \pm\; 0,003         & 9,83 \pm\; 0,12       \\
            Masa 2, 45\textdegree & 0,235 \pm\; 0,003         & 9,28 \pm\; 0,12       \\
            \hline
        \end{tabular}
    \end{centering}
\end{table}
...
de las gráficas~\ref{fig:1-20-3},~\ref{fig:1-45-3},~\ref{fig:2-20-3} y~\ref{fig:2-45-3}.

Concretamente: $q = 2$, $\alpha = 9.81 / 4\pi^2$ y $\log_{10} \alpha = -0.605$.
