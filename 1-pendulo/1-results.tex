...
Observamos que el periodo $T$ es ligeramente mayor para el ángulo de 45\textdegree\;que para el de 25\textdegree.
...
A continuación, las figuras~\ref{fig:1-20-1},~\ref{fig:1-45-1},~\ref{fig:2-20-1} y~\ref{fig:2-45-1} muestran las gráficas del periodo $T$
...
A su vez, los resultados para ambas masas son similares, como era de esperar.

Representamos por último la longitud $l$ frente al periodo $T$ en escala log-log en las
...
Se agrupan en una línea de pendiente 2.

Observamos que los tiempos para amplitudes grandes son mayores que para amplitudes pequeñas.

También observamos que los tiempos medidos para las dos masas coinciden.
