...
\subsection{Discusión de los resultados de $g$}
...
El error absoluto de $g$ se calcula con el método de propagación lineal de errores mediante la expresión:
...
Se muestran más dígitos de los usuales en el error para observar mejor la dependencia con la longitud $l$.
...
Observamos que los datos de $g$ para cada medición tienen una dispersión y errores absolutos apreciables, mayores que los calculados a partir de la pendiente.

Fijándonos en los valores calculados a partir de la pendiente,
...
dentro del margen de error o muy cerca de él.

Sin embargo, para el ángulo $\theta = 45\text{\textdegree}\,$, el mayor periodo del movimiento hace que se obtenga un valor $g$ menor del esperado.

\subsection{Dependencia de la incertidumbre de $g$ con $l$}

El error absoluto de $l$ es el mismo en todas las mediciones.
Para valores altos de $l$, el error relativo cometido en la medición es menor.
Esto se traduce, según se puede observar en las tablas~\ref{tab:1-t4-20},~\ref{tab:1-t4-45},~\ref{tab:2-t4-20} y~\ref{tab:2-t4-45},
